...
if __name__ == "__main__":
    for table in [
        "preqldata.public_geo.osm_cities",
        "preqldata.public_geo.osm_countries",
        "preqldata.public_geo.osm_state_province",
    ]:
        try:
            ...
            print("\nMake sure you have:")
            print(
                "1. Installed required packages: pip install google-cloud-bigquery pyarrow"
            )
            print(
                "2. Set up Google Cloud authentication (gcloud auth login or service account)"
            )
